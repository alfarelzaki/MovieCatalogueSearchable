...
class MainViewModelTVShow : ViewModel() {
    ...
    internal fun setMovies(lang: String, query: String) {
        ...
        var url = ""
        if (query.isEmpty()) url = "https://api.themoviedb.org/3/discover/tv?api_key=$API_KEY&language=$lang"
        else url = "https://api.themoviedb.org/3/search/tv?api_key=$API_KEY&language=$lang&query=$query"
            ...
            override fun onSuccess(
                ...
                try {
                    ...
                    for (i in 0 until list.length()) {
                        ...
                        movieItems.year = movie.getString("first_air_date")
