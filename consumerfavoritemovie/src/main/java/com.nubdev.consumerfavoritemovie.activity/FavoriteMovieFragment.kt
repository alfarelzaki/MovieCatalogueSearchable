...
import com.nubdev.consumerfavoritemovie.adapter.FavoriteMovieAdapter
import com.nubdev.consumerfavoritemovie.database.DatabaseContract.MoviesColumns.Companion.CONTENT_URI_MOVIE
    ...
    private fun loadMovieAsync() {
        GlobalScope.launch(Dispatchers.Main) {
            ...
            if (movies.size > 0) {
                ...
                Log.d("providerkampret", movies.size.toString())
            } else {
